...
import { USAGE_TILE_GAP, USAGE_TILE_SIZE } from './usageCalendarDimensions'
    ...
    return (
        <>
            <div ref={scrollRef} className="w-full overflow-x-auto py-1" data-heatmap-layout={layout.mode}>
                ...
                >
                    <div
                        className="grid h-4 text-caption leading-none text-text-3"
                        style={{
                    ...
                    {hasRowLabels && (
                        <div
                            className="grid text-caption leading-none text-text-3"
                        ...
                        {layout.tiles.map((tile) => {
                            ...
                            const amount =
                                point?.total_tokens == null
                                    ? null
                                    : formatUsageTokens(point.total_tokens, i18n.language, t)
                            ...
                            return (
                                ...
                                >
                                    <button
                                        ...
                                        className={`relative block aspect-square rounded-[2px] border-0 p-0 hover:outline hover:outline-1 hover:outline-offset-1 hover:outline-text-1/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 ${future || outside ? 'bg-fill-2/50' : USAGE_HEAT_COLORS[level]}`}
            ...
            {activeTooltip &&
                createPortal(
                    <div
                        ...
                        className="pointer-events-none fixed z-[130] max-w-[250px] space-y-1 overflow-visible rounded-md bg-text-1 dark:bg-background px-3 py-1.5 text-caption text-white shadow-md"
                        style={{
                    ...
                    >
                        ...
                        <span
                            aria-hidden="true"
                            className={`absolute size-2 -translate-x-1/2 rotate-45 bg-text-1 dark:bg-background ${
