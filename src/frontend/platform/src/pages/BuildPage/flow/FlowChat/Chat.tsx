...
export default function Chat({
    ...
    return <div className="h-full bs-chat-bg" style={{ backgroundImage: `url(${__APP_ENV__.BASE_URL}/assets/points.png)` }}>
        <div className="relative h-full">
            ...
            <ChatInput autoRun={autoRun} version={version} clear={clear} form={form} wsUrl={wsUrl} onBeforSend={onBeforSend} onLoad={() => setLoading(false)} flow={flow} portalMode={portalMode} ></ChatInput>
        </div>
