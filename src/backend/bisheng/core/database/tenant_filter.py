...
_TENANT_AWARE_MODEL_MODULES = (
    ...
    "bisheng.database.models.review_tags",
    ...
    "bisheng.knowledge.domain.models.knowledge_background_job",
    ...
    "bisheng.open_endpoints.domain.models.filelib_scheduled_sync_run_log",
