...
export default function ReportWordEdit({ data, nodeId, onChange }) {
    const { t } = useTranslation()

    const { docx, loading, createDocx, importDocx } = useReport(data, onChange)
