...
export default function SiblingSwitch({
  ...
  return siblingCount > 1 ? (
    <div className="visible flex items-center justify-center gap-1 self-center pt-0 text-xs">
      <button
        className={cn(
          'hover-button rounded-md p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-500 dark:text-gray-400/70 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400 fine-pointer:group-hover:visible fine-pointer:group-[.final-completion]:visible',
        )}
        type="button"
        onClick={previous}
