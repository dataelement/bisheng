...
from bisheng.utils.util import replace_domain
...
class TTSNode(BaseNode):
    ...
    def __init__(self, *args, **kwargs):
        ...
        print("TTSNode __init__",args,kwargs)
        self._tab = "batch"
        ...
        # 初始化llm对象
        self._stream = True
        self._tts = LLMService.get_bisheng_tts(model_id=self.node_params['model_id'])
