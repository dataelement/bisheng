...
| 实现 | 🔲 未开始 | 0 / 15 完成。偏差处理见 design.md 顶部调整原则 + `docs/SDD-Guide.md` §3-§4 |
...
- [ ] **T002**: 实现 annotate + ImageRegistry
...
- [ ] **T007**: run_vision_tool_loop 与 relocate 单元测试
...
- [ ] **T010**: 知识空间接入 run_vision_tool_loop
...
- [ ] **T012**: 频道编排迁入 ChannelChatService
...
- [ ] **T014**: 日常接入 annotate + VisionToolBindWrapper
