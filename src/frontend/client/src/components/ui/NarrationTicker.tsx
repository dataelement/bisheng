/**
 * NarrationTicker — a single-line "live thought" ticker shown under a
 * deep-thinking group header. Shared by the task-mode execution flow (R2 旁白)
 * and the daily-chat thinking group; lives here (neutral ground) because those
 * two surfaces must not import from each other.
 *
