...
@router.get('')
async def get_all_llm(request: Request, login_user: UserPayload = Depends(get_login_user)):
...
@router.delete('')
async def delete_llm_server(request: Request, login_user: UserPayload = Depends(get_admin_user),
...
@router.post('/online')
async def update_model_online(request: Request, login_user: UserPayload = Depends(get_admin_user),
...
async def update_knowledge_llm(request: Request, login_user: UserPayload = Depends(get_admin_user),
...
async def get_assistant_llm(request: Request, login_user: UserPayload = Depends(get_login_user)):
    """ 获取助手相关的模型配置 """
...
async def update_assistant_llm(request: Request, login_user: UserPayload = Depends(get_admin_user),
...
async def get_evaluation_llm(request: Request, login_user: UserPayload = Depends(get_login_user)):
    """ 获取评测相关的模型配置 """
...
async def update_evaluation_llm(request: Request, login_user: UserPayload = Depends(get_admin_user),
...
@router.get('/workflow')
async def get_workflow_llm(request: Request, login_user: UserPayload = Depends(get_login_user)):
    """ 获取工作流相关的模型配置 """
...
async def update_workflow_llm(request: Request, login_user: UserPayload = Depends(get_admin_user),
