                                        ...
                                        {!isNarrowMobileLayout && (
                                            <div className="flex items-center gap-3">
                                                ...
                                                <Button
                                                    ...
                                                    variant="outline"
                                                    className="h-8 rounded-md border-transparent bg-fill-1 px-3 py-0 text-[14px] font-normal leading-none text-text-2 [backdrop-filter:blur(4px)] hover:bg-[#f0f0f0] active:translate-y-0"
                                                >
                                ...
                                {isNarrowMobileLayout && (
                                    <div className="flex min-w-0 flex-nowrap items-center gap-3 overflow-x-auto pb-0.5 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                                        ...
                                        <Button
                                            ...
                                            className={
                                                onlyUnread
                                                    ...
                                                    : "h-8 shrink-0 rounded-md border border-border-base bg-white/50 px-4 py-[5px] text-[14px] font-normal text-text-1 [backdrop-filter:blur(8px)]"
                                            }
                                        >
                                            {localize("com_notifications_unread_only")}
                                        </Button>
                                        <Button
                                            ...
                                            variant="outline"
                                            className="h-8 shrink-0 rounded-md border-transparent bg-fill-1 px-4 py-[5px] text-[14px] font-normal text-text-1 [backdrop-filter:blur(8px)]"
                                        >
                                            {localize("com_notifications_mark_all_read")}
                                        </Button>
                                    </div>
