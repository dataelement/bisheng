...
_fga_read_stats_var: contextvars.ContextVar[Optional[FGAReadStats]] = contextvars.ContextVar(
    'fga_read_stats',
    default=None,
)
...
class FGAClient:
    ...
    def clear_read_tuples_cache(self, objects: Optional[Iterable[str]] = None) -> None:
