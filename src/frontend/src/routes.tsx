...
import SkillAssisPage from "./pages/BuildPage/tabAssistant";
import EditAssistantPage from "./pages/BuildPage/editAssistant";
import SkillsPage from "./pages/BuildPage/tabSkills";
import SkillToolsPage from "./pages/BuildPage/tabTools";
import L2Edit from "./pages/BuildPage/l2Edit";
import SystemPage from "./pages/SystemPage";
import BuildLayout from "./layout/BuildLayout";
import Templates from "./pages/BuildPage/temps";
