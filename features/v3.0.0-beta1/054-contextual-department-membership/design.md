...
此片段只列出相关关系；现有 parent、child、admin 和全部资源定义保留。旧定义为 `member or subtree_member from child`。新模型版本为 `f048-v4-contextual-departments`，checksum 为 `1898712aa30c46354edbb1878f3bd9ebb17483926b39e696c1a13c29a6a1e733`。
