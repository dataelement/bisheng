...
from bisheng.department.api.endpoints.department_org_level import router as org_level_router
...
# F070 org-levels / set-company-root 须在 ``GET /{dept_id}`` 之前，避免 ``org-levels`` 被当成 dept_id。
router.include_router(member_router)
router.include_router(org_level_router)
