...
- 可在文字右侧挂**数字徽标**（未读数、条目数），取自频道模块子频道页签的现行画法：高 16px、最小宽 16px、圆角 6px、字号 caption-sm/字重 500，底色为当前配色款主色 5% 透明度、文字为该主色，与文字的间距同 icon（small 档 4px，其余 8px）。
  ...
  - 徽标的完整样式体系（尺寸档、语义色、超限显示）仍待 Badge 规范建档后归口，本文只定标签页里的这一种用法。
