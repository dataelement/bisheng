...
def test_portal_site_config_round_trips_home_cache_ttl():
    raw_config = _minimal_portal_config()
    raw_config["site"] = {"home_cache_ttl_seconds": 900}
...
def test_portal_site_config_defaults_and_validates_home_cache_ttl():
    ...
    assert config.portal.site.home_cache_ttl_seconds == 1800

    raw_config = _minimal_portal_config()
    raw_config["site"] = {"home_cache_ttl_seconds": 59}
