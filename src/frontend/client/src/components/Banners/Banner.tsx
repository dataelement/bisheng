...
import { useGetBannerQuery } from '~/hooks/queries/data-provider';
...
export const Banner = ({ onHeightChange }: { onHeightChange?: (height: number) => void }) => {
  ...
  return (
    <div
      ref={bannerRef}
      className="sticky top-0 z-20 flex items-center bg-neutral-900 from-gray-700 to-gray-900 px-2 py-1 text-slate-50 dark:bg-gradient-to-r dark:text-white touch-desktop:relative"
    >
      <div
