-- BiSheng 3.0.0-beta1 permission configuration queries (MySQL dialect).
-- DM8: replace backticks with double quotes (also needed for the mode and protected columns).
...
-- Q7c Super admins / child-tenant admins recorded only in the OpenFGA datastore (database `openfga`)
