...
QA_KNOWLELDGE_METADATA_SCHEMA = [
    ...
    RagMetadataFieldSchema(field_name="knowledge_id", field_type="text", kwargs={"nullable": True}),
    RagMetadataFieldSchema(field_name="page", field_type="int64", kwargs={"nullable": True}),
    RagMetadataFieldSchema(field_name="source", field_type="text", kwargs={"nullable": True}),
    RagMetadataFieldSchema(field_name="bbox", field_type="text", kwargs={"nullable": True}),
    RagMetadataFieldSchema(field_name="title", field_type="text", kwargs={"nullable": True}),
    RagMetadataFieldSchema(field_name="chunk_index", field_type="int64", kwargs={"nullable": True}),
    RagMetadataFieldSchema(field_name="extra", field_type="text", kwargs={"nullable": True}),
]
