          ...
          .map((item, index) => {
            ...
            return (
              <Ariakit.MenuItem
                ...
                id={item.id}
                className={cn(
                  'group flex w-full cursor-pointer items-center gap-2 rounded-lg px-3 py-3.5 text-sm text-text-primary outline-none transition-colors duration-200 hover:bg-surface-hover focus:bg-surface-hover touch-desktop:px-2.5 touch-desktop:py-2',
                  itemClassName,
                )}
