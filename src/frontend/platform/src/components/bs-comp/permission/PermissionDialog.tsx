    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent
          ...
          className="flex h-[80vh] max-h-[800px] w-[calc(var(--bs-vw,100vw)-80px)] max-w-[800px] min-w-0 flex-col gap-0 overflow-hidden p-0"
        >
      ...
      {context && canAddPermission && (
        <Dialog open={grantDialogOpen} onOpenChange={setGrantDialogOpen}>
          <DialogContent
            ...
            className="flex h-[80vh] max-h-[800px] w-[calc(var(--bs-vw,100vw)-80px)] max-w-[800px] min-w-0 flex-col gap-0 overflow-hidden p-5"
          >
