            ...
            <div className="flex justify-between h-[64px]">
                ...
                <div className="flex w-fit">
                    ...
                    <div className="flex h-8 my-4">
                        <img className="h-8 w-8 rounded-2xl mr-4" src="/user.png" alt="" />
                        <span className="leading-8 text-[14px] mr-8">{t("menu.user")}</span>
                    </div>
                </div>
            </div>
            <div className="flex" style={{height:"calc(100vh - 64px)"}}>
                <div className="relative z-10 bg-[#f4f5f8] h-full w-[184px] px-3  shadow-x1 flex justify-between text-center ">
                    <nav className="">
                        ...
                        <NavLink to='/build/assis' className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-[white] h-12 mb-[3.5px] ${location.pathname === '/build/assis'?"bg-[white] text-[#0055e3] shadow-sm":""}`}>
                    ...
                    <div className="absolute left-0 bottom-0 w-[180px] p-2">
                        ...
                        <div className="flex  items-between my-3">
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger className="h-[72px] w-[78px] cursor-pointer bg-[white] rounded-lg hover:bg-[#1b1f23] hover:text-[white]">
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger className="h-[72px] w-[78px] cursor-pointer bg-[white] rounded-lg p-0 align-top hover:bg-[#0055e3] hover:text-[white]">
                        ...
                        <div className="flex h-[48px] w-[160px] bg-[#ebedf1]">
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger className="flex-1 py-1 rounded-sm hover:bg-[#dadce0] dark:hover:bg-gray-600 cursor-pointer">
