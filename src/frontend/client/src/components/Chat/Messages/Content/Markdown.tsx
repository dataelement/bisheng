...
function CitationPreviewCard({
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-[120px] w-[320px] max-w-[calc(var(--bs-vw,100vw)-32px)] items-center justify-center rounded-lg bg-white text-sm text-text-3 shadow-[0_4px_19px_rgba(34,34,34,0.07)]">
  ...
  if (notPermitted) {
    return (
      <div className="w-[320px] max-w-[calc(var(--bs-vw,100vw)-32px)] rounded-lg bg-white p-4 text-sm text-text-3 shadow-[0_4px_19px_rgba(34,34,34,0.07)]">
        暂无权限
      </div>
    );
  }
  ...
  const cardClassName = 'group relative cursor-pointer w-[320px] max-w-[calc(var(--bs-vw,100vw)-32px)] overflow-hidden rounded-lg bg-white text-text-1 shadow-[0_4px_19px_rgba(34,34,34,0.07)]';
