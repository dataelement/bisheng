          ...
          {({ open }) => (
            <>
              ...
              >
                <ListboxOptions
                  className={cn(
                    'absolute z-10 mt-2 max-h-60 w-full overflow-auto rounded border bg-white text-xs ring-black/10 dark:border-gray-600 dark:bg-gray-700 dark:ring-white/20 touch-desktop:w-[100%]',
                    optionsListClass ?? '',
                  )}
                >
                  {renderOption && (
