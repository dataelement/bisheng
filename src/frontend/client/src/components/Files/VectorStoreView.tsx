...
export default function VectorStoreView() {
  ...
  return (
    <div className="max-h-[var(--bs-vh,100vh)] bg-[#f9f9f9] p-0 lg:p-7">
      <div className="m-4 flex max-h-[10vh] w-full flex-row justify-between touch-desktop:m-2">
      ...
      <div className="flex max-h-[90vh] w-full flex-row divide-x">
        <div
          className={`max-h-full w-full xl:w-1/3 ${
            params.vectorStoreId ? 'lg:w-1/2' : 'hidden touch-desktop:w-1/2 lg:block'
          }`}
        >
