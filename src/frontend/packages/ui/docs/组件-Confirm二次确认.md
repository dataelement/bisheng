...
> 配套：圆角与投影见 [基础-圆角与阴影规范.mdx](基础-圆角与阴影规范.mdx)、颜色见 [基础-色彩规范.mdx](基础-色彩规范.mdx)、按钮见 [组件-Button按钮.md](组件-Button按钮.md)、文案见 [基础-文案规范.md](基础-文案规范.md)、移动端通则见 [基础-多端适配原则.md](基础-多端适配原则.md)。
...
圆角与模态投影随《圆角与阴影规范》，见 [基础-圆角与阴影规范.mdx](基础-圆角与阴影规范.mdx)。
