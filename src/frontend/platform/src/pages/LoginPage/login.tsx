    ...
    return <div className='w-full min-h-screen bg-background-dark flex items-center justify-center sm:py-4 overflow-y-auto'>
        <div className='relative z-10 sm:w-[1280px] w-full sm:h-[720px] h-full sm:shrink-0 border rounded-lg shadow-xl overflow-hidden bg-background-login'>
            <div className='w-[420px] h-[704px] m-[8px] hidden sm:block relative z-20'>
                <img src={getBrandAssetUrl('loginHeroLight', '/assets/bisheng/logo.svg')} alt="logo_picture" className='w-full h-full dark:hidden' />
                <img src={getBrandAssetUrl('loginHeroDark', '/assets/bisheng/logo.svg')} alt="logo_picture" className='w-full h-full hidden dark:block' />
            ...
            <div className='absolute w-full h-full z-10 flex justify-end top-0'>
                <div className='w-[852px] sm:px-[266px] px-[20px] pyx-[200px] bg-background-login relative'>
                    <div>
                        <img src={getBrandAssetUrl('headerLogoLight', '/assets/bisheng/logo.svg')} className="block w-[114px] h-[36px] m-auto mt-[140px] dark:w-[124px] dark:pr-[10px] dark:hidden" alt="" />
                        <img src={getBrandAssetUrl('headerLogoDark', '/assets/bisheng/logo.svg')} className="w-[114px] h-[36px] m-auto mt-[140px] dark:w-[124px] dark:pr-[10px] dark:block hidden" alt="" />
