...
class SkillService:
    ...
    def _parse_upload(
        ...
        *,
        ...
        max_unpacked: int = MAX_UNPACKED_SIZE,
        ...
        if lower.endswith(_ARCHIVE_SUFFIXES):
            try:
                # The unpacked cap is checked inside, before anything is decompressed.
                files = unpack_zip_bytes(data, max_unpacked=max_unpacked)
