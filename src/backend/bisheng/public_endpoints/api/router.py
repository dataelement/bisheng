...
# Public requests always execute as the configured operator; caller credentials
# and identity headers neither grant access nor prevent anonymous access.
router_public = APIRouter(prefix="/api/v3")
