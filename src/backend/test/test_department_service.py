...
class TestMoveDepartmentSubtreeSync:
    ...
    @pytest.mark.asyncio
    async def test_move_default_root_department_is_forbidden(self):
        ...
        with (
            ...
            patch(
                "bisheng.department.domain.services.department_service.aassert_default_root_parent_immutable",
                new=AsyncMock(
                    side_effect=DepartmentDefaultRootMoveForbiddenError(),
                ),
            ),
        ):
