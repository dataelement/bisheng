...
const AiModelSelect = memo(
    ({ options, value, disabled, onChange }: AiModelSelectProps) => {
        ...
        return (
            ...
            >
                <SelectTrigger className="h-8 w-auto min-w-0 max-w-[min(50vw,240px)] touch-mobile:max-w-[min(45vw,160px)] touch-mobile:px-1.5 gap-1 overflow-hidden border-none bg-transparent px-2 text-[#4E5969] shadow-none outline-none hover:bg-black/5 focus:ring-0">
