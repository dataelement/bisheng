...
class KnowledgeSpaceFilePublishApprovalHandler:
    ...
    async def build_detail(self, req) -> dict:
        return {
            ...
            "original_uploader_id": req.payload_snapshot.get("original_uploader_id"),
            "original_uploader_name": req.payload_snapshot.get("original_uploader_name"),
            "original_knowledge_id": req.payload_snapshot.get("original_knowledge_id"),
            "original_knowledge_name": req.payload_snapshot.get("original_knowledge_name"),
