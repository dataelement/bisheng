          ...
          <TooltipProvider delayDuration={300}>
            <Tooltip>
              ...
              <TooltipContent
                ...
                className={cn(
                  isGuest
                    ? 'max-w-[min(var(--bs-vw,100vw)-2rem,320px)] !rounded-[20px] !border !border-border-base !bg-white !p-5 !text-sm !font-normal !leading-normal !text-text-1 !shadow-[0_8px_32px_rgba(0,0,0,0.12)]'
                    : 'max-w-[320px] p-3',
                )}
              >
                {isGuest ? (
