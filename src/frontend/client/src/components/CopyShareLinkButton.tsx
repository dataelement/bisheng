...
export function CopyShareLinkButton({
    ...
    return (
        <Button
            ...
            className={cn(
                iconOnly
                    ? "h-8 w-8 shrink-0 justify-center rounded-md border border-border-base bg-white p-0 transition-colors hover:bg-fill-1"
                    : "h-8 gap-1 px-4 font-normal transition-colors hover:bg-fill-1 touch-mobile:rounded-md touch-mobile:border touch-mobile:border-border-base touch-mobile:bg-white touch-mobile:px-4 touch-mobile:text-text-1",
                className,
            )}
        >
