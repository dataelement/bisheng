                        ...
                        {(!form.showSuccess || isEditMode) && (
                            <div className="sticky bottom-0 z-10 mt-auto mx-6 flex justify-end gap-3 border-t border-[#E5E6EB] bg-white px-0 pb-5 pt-10 touch-mobile:mx-0 touch-mobile:gap-2 touch-mobile:px-0 touch-mobile:pt-4">
                                ...
                                <Button
                                    ...
                                    className="inline-flex h-8 items-center justify-center rounded-md border-none bg-blue-500 px-4 text-[14px] leading-none !font-normal text-white hover:bg-blue-400 disabled:opacity-50 touch-mobile:flex-1 btn-brand-primary"
                                >
                                    {isEditMode
