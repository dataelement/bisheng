        ...
        <div ref={rootRef} className="relative">
            ...
            {expanded && (
                <div
                    ...
                    className={cn(
                        "absolute left-0 right-0 top-0 z-[100] flex flex-col overflow-hidden rounded-lg border border-[#E5E6EB] bg-white shadow-[0_4px_16px_rgba(0,0,0,0.12)]",
                        "h-[440px] min-w-[400px]",
                ...
                >
                    ...
                    {mgr.viewMode === "list" && (
                        <div className="relative z-[1] flex shrink-0 items-center justify-between border-t border-[#E5E6EB] bg-white px-4 py-3 touch-mobile:flex-col touch-mobile:items-stretch touch-mobile:gap-2">
