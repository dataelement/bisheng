...
> 与 [00-总纲.md](00-总纲.md)、[01-设计规范.md](01-设计规范.md) 配套；字号见 [基础-字体规范.mdx](基础-字体规范.mdx)、颜色见 [基础-色彩规范.mdx](基础-色彩规范.mdx)、圆角见 [基础-阴影与圆角规范.mdx](基础-阴影与圆角规范.mdx)、图标见 [基础-图标规范.mdx](基础-图标规范.mdx)、移动端通则见 [基础-多端适配原则.md](基础-多端适配原则.md)。
...
- **圆角跟《阴影与圆角规范》的控件档走**：4 / 6 / 8px 随尺寸档取，见 [基础-阴影与圆角规范.mdx](基础-阴影与圆角规范.mdx)。
