...
- 墨色款深色模式天然成立：text-1 深色下翻转为近白，无对比度债，不需要品牌款那套提亮补丁（见下条）。
- 两款只是换色，结构、尺寸、动效、交互完全一致；一个标签行只能选一款，不许混用。
- **品牌款深色模式选中态亮一档**（brand-400，定档记录见改动记录）：品牌色深色阶未建（已知债），brand-500 在 #121212 上只有 3.6:1，比未选中的次要文字（8.2:1）还暗——选中项成了整行最哑的，视觉上「后退、显小」。三档实测后定 brand-400（5.2:1）：500 太暗；300 亮但发白——浅色阶提亮靠往白里兑，亮度上去彩度流失，没有品牌感；400 与 Arco 官方深色主色（#3C7EFF）同落点。深色下选中不靠亮度压邻居，靠**色相 + 500 字重 + 指示条**三重信号。手法同按钮深色品牌文字（Button §5.2 dark 处理）；「亮与饱和兼得」只能靠品牌深色阶，建档后归口统一。
