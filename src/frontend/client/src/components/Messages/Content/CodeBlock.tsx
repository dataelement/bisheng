...
const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  const codeBodyScroll = useScrollbarWhileScrolling();
  ...
  return (
    <div className="w-full rounded-md bg-gray-900 text-xs text-white/80">
      ...
      />
      <div
        className={cn(classProp, 'overflow-y-auto scroll-on-scroll p-4')}
        onScroll={codeBodyScroll.onScroll}
        {...codeBodyScroll.scrollingProps}
      >
        <code
          ref={codeRef}
          className={cn(
