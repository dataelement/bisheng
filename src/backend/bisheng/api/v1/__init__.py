...
def __getattr__(name):
    ...
    exports = {
        ...
        'invite_code_router': invite_code_router,
        'mark_router': mark_router,
        'report_router': report_router,
        'skillcenter_router': skillcenter_router,
        'tag_router': tag_router,
        'tool_router': tool_router,
        'user_router': user_router,
        'variable_router': variable_router,
        'workflow_router': workflow_router,
        'workstation_router': workstation_router,
    }
    return exports[name]
