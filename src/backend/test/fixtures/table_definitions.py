...
TABLE_KNOWLEDGE_TAG_LIBRARY_LINK = """\
CREATE TABLE IF NOT EXISTS knowledge_tag_library_link (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    tenant_id INTEGER NOT NULL DEFAULT 1,
    knowledge_id INTEGER NOT NULL,
    tag_library_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS space_channel_member (
    ...
    department_admin_promoted_from_role VARCHAR(32),
    relation VARCHAR(32),
    grant_subject_type VARCHAR(32),
    grant_subject_id INTEGER,
    grant_relation VARCHAR(32),
    grant_include_children INTEGER NOT NULL DEFAULT 0,
    grant_model_id VARCHAR(64),
    grant_binding_key VARCHAR(255),
