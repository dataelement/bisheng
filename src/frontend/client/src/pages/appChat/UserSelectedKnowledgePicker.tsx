    ...
    return (
        <div className="w-full rounded-2xl border border-[#dbe7fb] bg-white p-4 shadow-[0_18px_44px_rgba(15,23,42,0.14)]">
            ...
            <div className="relative mb-3">
                ...
                <input className="h-9 w-full rounded-md border border-[#d8e4f5] bg-[#fbfdff] pl-9 pr-2 text-sm outline-none placeholder:text-[#8a9ab8] focus:border-[#7fb0ff]" value={keyword} disabled={disabled} placeholder="搜索知识空间名称" onChange={(event) => setKeyword(event.target.value)} />
            </div>
