...
from bisheng.open_endpoints.api.endpoints.rpc import router as rpc_router_rpc
...
__all__ = [
    ...
    'assistant_router_rpc', 'workflow_router_rpc', 'workstation_router_rpc', 'filelib_router_rpc'
]
