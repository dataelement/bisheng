...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Description
        ref={ref}
        className={cname("text-sm text-muted-foreground text-center text-gray-800", className)}
        {...props}
    />
))
