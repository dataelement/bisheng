...
export const sidebarListMoreMenuItemClassName =
    "flex w-full cursor-pointer items-center gap-2 rounded-md px-2 py-[5px] text-sm leading-[22px] text-text-1 data-[highlighted]:bg-fill-2 focus:bg-fill-2";

export const sidebarListMoreMenuIconClassName = "size-4 shrink-0 text-text-2";

export const sidebarListMoreMenuLabelClassName = "text-sm leading-[22px] text-text-1";
