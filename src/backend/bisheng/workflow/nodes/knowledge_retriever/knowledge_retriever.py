...
class KnowledgeRetriever(RagUtils):
    ...
    def _run(self, unique_id: str):
        try:
            ...
            for index, question in enumerate(self.user_questions):
                ...
                try:
                    ...
                    if self._knowledge_type in ("knowledge", "space"):
                        ...
                        question_answer = annotate_temp_documents_with_citations(question_answer)
                        citation_items = collect_temp_citation_registry_items(question_answer)
            ...
            ret = {one: str(e) for one in self._output_keys}
        return ret
