...
def data_loader():
    ...
    start_time = time.time()
    ssl_verify = {'ca_certs': "/home/public/liuqingjie/Elasticsearch/http_ca.crt",
                  'basic_auth': ("elastic", "F94h5JtdQn6EQB-G9Hjv"), 'verify_certs': False}
    vector_store = ElasticKeywordsSearch.from_documents(
        split_docs, embeddings, elasticsearch_url="https://192.168.106.14:9200",
