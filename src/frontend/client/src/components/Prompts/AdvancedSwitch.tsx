...
const AdvancedSwitch = () => {
  ...
  return (
    <div className="relative flex h-10 items-center justify-center rounded-xl border border-border-light bg-surface-primary transition-all duration-300">
      <div className="relative flex w-48 items-stretch touch-desktop:w-64">
        <div
        ...
        <button
          ...
          className={`relative z-10 flex-1 rounded-xl px-3 py-2 text-sm font-medium transition-all duration-300 touch-desktop:px-6 ${
