...
// 节点表单项
export default function Parameter({ nodeId, item, onOutPutChange, onStatusChange }
    : {
        nodeId: string,
    ...
    switch (item.type) {
        ...
        case 'var_textarea_file':
            return <VarTextareaUploadItem nodeId={nodeId} data={item} onChange={handleOnNewValue} onValidate={bindValidate}/>
        case 'output_form':
        ...
        case 'var_textarea':
            return <VarTextareaItem nodeId={nodeId} data={item} onChange={handleOnNewValue} onValidate={bindValidate} />
        case 'switch':
