export function formatUsageTokens(value: number, locale: string, t: (key: string) => string) {
        ...
        const levels = [
            {
                ...
                unit: t('dsh.units.trillion'),
            },
            {
                threshold: 100_000_000_000,
                divisor: 100_000_000_000,
                unit: t('dsh.units.hundredBillion'),
                maximum: 9.99,
            },
            {
                threshold: 100_000_000,
                divisor: 100_000_000,
                unit: t('dsh.units.hundredMillion'),
                maximum: 999.99,
            },
            {
                threshold: 10_000,
                divisor: 10_000,
                unit: t('dsh.units.tenThousand'),
                maximum: 9_999.99,
            },
        ]
