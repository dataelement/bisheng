...
from langchain_contrib.document_loaders.parsers import LayoutParser
...
class PDFWithSemanticLoader(BasePDFLoader):
    ...
    def __init__(
        ...
        self.layout_parser = LayoutParser(
             api_key=layout_api_key, api_base_url=layout_api_url)
        ...
        for i in range(1, len(groups)):
            ...
            if b0_label and b0_label == b1_label and b0_label == TEXT_ID:
                ...
                if (c0 > LINE_FULL_THRESHOLD and c1 < START_THRESHOLD and 
                    ...
                    new_block = (
                        b0[0], b0[1], b0[2], b0[3], new_text, b0[5], b0[6])
