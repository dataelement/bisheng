  ...
  return (
    <div className="mx-auto p-1 touch-desktop:container">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="mb-6 max-h-[var(--bs-vh,100vh)] max-w-[90vw] overflow-auto rounded-md bg-gray-100 p-4 text-text-secondary dark:bg-gray-700/50 sm:max-w-full touch-desktop:max-h-80">
          <ReactMarkdown
            /** @ts-ignore */
