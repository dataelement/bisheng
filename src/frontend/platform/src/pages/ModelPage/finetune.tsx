            ...
            {tasks?.length === 0 ?
                ...
                : <div className="flex gap-4 mt-4">
                    <div className="w-[40%] relative">
                        <div className="border-r overflow-y-auto max-h-[calc(var(--bs-vh,100vh)-150px-var(--license-banner-h,0px))] pb-20">
                    ...
                    <div className="flex-1 overflow-hidden overflow-y-auto max-h-[calc(var(--bs-vh,100vh)-150px-var(--license-banner-h,0px))]">
                        {taskId ?
