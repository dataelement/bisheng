...
# Keyword hints for splitting a multi-file direct answer when the model never
# called write_file (fallback synthesis).
_SECTION_HINTS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("转录", ("音频", "乔布斯", "wav", "mp3", "转录", "录音")),
    ("音频", ("音频", "乔布斯", "wav", "mp3", "转录", "录音")),
    ("somna", ("somna", "视频", "索娜", "宣传片", "mp4")),
    ("解析", ("somna", "视频", "索娜", "宣传片", "台词")),
    ("视频", ("视频", "somna", "索娜", "宣传片", "mp4")),
    ("综合", ()),
    ("摘要", ()),
    ("总结", ()),
)
...
def _section_relevance_score(section: str, filename: str) -> int:
    ...
    for key, keywords in _SECTION_HINTS:
